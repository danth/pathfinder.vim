...
from pathfinder.client.popup import open_popup, _vim_popup, _neovim_popup
...
def test_vim_popup():
    ...
    popup_create.assert_called_once_with("hello world", {
        "line": "cursor+1",
        "col": "cursor",
        "wrap": False,
        "padding": (0, 1, 0, 1),
...
@mock.patch("pathfinder.client.popup.vim.api.open_win", return_value=mock.sentinel.window)
@mock.patch("pathfinder.client.popup.vim.api.buf_set_lines")
@mock.patch("pathfinder.client.popup.vim.api.create_buf", return_value=mock.sentinel.buffer)
def test_neovim_popup(create_buf, buf_set_lines, open_win, win_set_option, vim_eval):
    ...
    open_win.assert_called_once_with(mock.sentinel.buffer, 0, {
        "relative": "cursor",
        "row": -1,
        "col": 0,
        "style": "minimal",
