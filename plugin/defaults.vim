...
if !exists('g:pf_motions')
  let g:pf_motions = [
    ...
    \ {'motion': '\<C-e>', 'name': '<C-e>', 'weight': 1, 'description': 'Scroll downward {count} lines'},
    \ {'motion': '\<C-y>', 'name': '<C-y>', 'weight': 1, 'description': 'Scroll upward {count} lines'},
    \ {'motion': '\<C-f>', 'name': '<C-f>', 'weight': 1, 'description': 'Scroll forward {count} pages'},
    \ {'motion': '\<C-b>', 'name': '<C-b>', 'weight': 1, 'description': 'Scroll backward {count} pages'},
    \ {'motion': '\<C-d>', 'name': '<C-d>', 'weight': 1, 'description': 'Scroll downward {count} times'},
    \ {'motion': '\<C-u>', 'name': '<C-u>', 'weight': 1, 'description': 'Scroll upward {count} times'},
    \ {'motion': 'zt', 'weight': 2, 'description': 'Current line to the top of the window'},
    \ {'motion': 'z\<CR>', 'name': 'z<CR>', 'weight': 2, 'description': 'Current line to the top of the window and move to the first non-blank character'},
    \ {'motion': 'zz', 'weight': 2, 'description': 'Current line to the centre of the window'},
    \ {'motion': 'z.', 'weight': 2, 'description': 'Current line to the centre of the window and move to the first non-blank character'},
    \ {'motion': 'zb', 'weight': 2, 'description': 'Current line to the bottom of the window'},
    \ {'motion': 'z-', 'weight': 2, 'description': 'Current line to the bottom of the window and move to the first non-blank character'},
    \
