...
class StartNode:
    ...
    def test_motion(self, motion):
        ...
        if new_view["lnum"] != self.view["lnum"] or new_view["col"] != self.view["col"]:
        ...
        for motion in available_motions:
            ...
            if child_node.key() in nodes:
                ...
                if (
                    ...
                    preexisting_child_node.incoming_motions.append(motion)
                elif child_node.g < preexisting_child_node.g:
                    # This is a shorter route (lower g), discard the existing node and
                    # replace it with this one.
                    preexisting_child_node.__dict__.update(child_node.__dict__)
